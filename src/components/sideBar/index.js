...
export function SideBar(props) {
    ...
    return (
        <>
            ...
            <i onClick={props.menu} id="bars" class={props.animated?(props.active ? "bars-menu" : "opened bars-menu"):"bars-menu opened no_animate"} ><svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
